...
var MAX_CHECK_INTERVAL = 1000; // ms
...
function Api(options) {
  ...
  function average(arr) {
    ...
    return Math.max.apply(null, arrWithoutNulls)
  ...
  var getToken = function () {
    return new Promise(function (resolve, reject) {
      ...
      var ret = get(FAST_URL, true).then(function (ret) {
        ...
        return_values.ucount = (min_url_count && min_url_count > line.split("urlCount:")[1]) ? min_url_count : line.split("urlCount:")[1]
  ...
  var getSpeed = function (targets) {
    ...
    return new Promise(function (resolve) {
      ...
      var interval = Math.min(MAX_CHECK_INTERVAL); // ms
